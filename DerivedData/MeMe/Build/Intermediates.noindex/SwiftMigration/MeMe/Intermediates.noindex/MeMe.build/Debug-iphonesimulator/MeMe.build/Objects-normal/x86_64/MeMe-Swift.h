...
SWIFT_MODULE_NAMESPACE_PUSH("MeMe")
@class UIWindow;
@class UIApplication;
...
@property (nonatomic, readonly, strong) UIImagePickerController * _Nonnull pickerController;
...
- (void)imagePickerControllerDidCancel:(UIImagePickerController * _Nonnull)textField;
